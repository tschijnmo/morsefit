...
def morse_e(r, mp):
    ...
    :param mp: An iterator, mostly a numpy 1-D array, holding the D_e, a, and
      r_0 parameters for the Morse potential.
...
def morse_d_r0(r, mp):
    ...
    """Compute the partial derivative of Morse energy wrt r0"""
